...
class ServiceAdmin(admin.ModelAdmin):
    ...
    Features:
    - Display price range for flexible pricing
    - Inline service items management
    - Filtering and search capabilities
    - Service type and availability management
    """
    list_display = (
    ...
    def price_display(self, obj):
        ...
        Returns:
            str: Formatted price display
        """
        if obj.has_flexible_pricing:
            if obj.service_items.exists():
    ...
    def min_price(self, obj):
        ...
        """
        if obj.has_flexible_pricing and obj.service_items.exists():
